...
F.Taskbar.refresh = function() {
    ...
    var $taskbar_icons = $('.taskbar-icons');
    $taskbar_icons.children('.taskicon').removeClass('current opened');
    ...
    $taskbar_icons.children('.taskicon[data-process-opener="1"]').unbind('click').click(function() {
        F.Application.load({
            process_name: $(this).attr('data-process-id')
        });
    });

    $taskbar_icons.children('.taskicon').unbind('click').click(function() {
