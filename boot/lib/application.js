...
/**
 * Creates an user's configuration file
 *
...
F.Application.createUserConfig = function (process_name, isSystemApp, user) {
    ...
    var userpath = User.getExternalUserPath('~/.apps');
...
/**
 * Gets an user's configuration file data
 *
 * @param {String} process_name
 * @param {boolean} isSystemApp
 * @param {String} user
...
F.Application.getUserConfig = function (process_name, isSystemApp, user, config_name) {
    ...
    if (!FS.exists(User.getExternalUserPath('~/.apps/'+process_name+'/app.json'))) {
        ...
        app_config_file = $.parseJSON(FS.read(User.getExternalUserPath('~/.apps/'+process_name+'/app.json')));
...
/**
 * Sets an user's configuration data
 *
 * @param {String} process_name
 * @param {boolean} isSystemApp
 * @param {String} user
...
F.Application.setUserConfig = function(process_name, isSystemApp, user, config) {
    ...
    if (!FS.exists(User.getExternalUserPath('~/.apps/'+process_name+'/app.json'))) {
        ...
        return FS.write(User.getExternalUserPath('~/.apps/'+process_name+'/app.json'), config);
    }
};

/**
 * Gets the default value of an user's configuration data
 *
 * @param {String} process_name
 * @param {boolean} isSystemApp
 * @param {String} config_name
...
/**
 * Gets an application's configuration data
 *
 * @param {String} process_name
 * @param {boolean} isSystemApp
 * @param {String} config_name
