...
F.Window.init = function (process_name, options) {
    ...
    param.maxWidth  = F.Application.getInfo(process_name, param.isSystemApp, 'max_width');
    param.maxHeight = F.Application.getInfo(process_name, param.isSystemApp, 'max_height');
